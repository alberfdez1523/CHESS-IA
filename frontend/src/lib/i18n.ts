...
export const UI_STRINGS = {
  es: {
    ...
    quantumCoachTitle: 'Primeras jugadas cuánticas',
    quantumCoachSelect: 'Elige una pieza no peón',
    quantumCoachSplit: 'Modo Cuántico: marca dos destinos',
    quantumCoachMerge: 'Fusiona dos estados cuando quieras recuperar control',
    quantumCoachMeasure: 'Las capturas resuelven la probabilidad con medición',
    quantumCoachTunnel: 'Las piezas pueden atravesar estados cuánticos',
  ...
  en: {
    ...
    quantumCoachTitle: 'First quantum moves',
    quantumCoachSelect: 'Choose a non-pawn piece',
    quantumCoachSplit: 'Quantum mode: mark two targets',
    quantumCoachMerge: 'Merge two states when you need control back',
    quantumCoachMeasure: 'Captures resolve probability through measurement',
    quantumCoachTunnel: 'Pieces can pass through quantum states',
